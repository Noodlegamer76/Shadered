...
public class RegisterShaders {
    ...
    public static void registerShaders(RegisterShadersEvent event) throws IOException {
        event.registerShader(new ShaderInstance(event.getResourceProvider(),
                        ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "skyblock_warp"),
        ...
        event.registerShader(new ShaderInstance(event.getResourceProvider(),
                        ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "compressor"),
        ...
        event.registerShader(new ShaderInstance(event.getResourceProvider(),
                        ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "skyblock"),
                        DefaultVertexFormat.POSITION_TEX),
                (e) -> {
                    skyblock = e;
        ...
        event.registerShader(new ShaderInstance(event.getResourceProvider(),
                        ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "skyblock_invert"),
                        DefaultVertexFormat.POSITION_TEX),
                (e) -> {
                    skyblockInvert = e;
        ...
        event.registerShader(new ShaderInstance(event.getResourceProvider(),
                        ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "skyblock_posterize"),
                        DefaultVertexFormat.POSITION_TEX),
                (e) -> {
                    skyblockPosterize = e;
        ...
        event.registerShader(new ShaderInstance(event.getResourceProvider(),
                        ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "skyblock_chromatic_aberration"),
                        DefaultVertexFormat.POSITION_TEX),
                (e) -> {
        ...
        event.registerShader(new ShaderInstance(event.getResourceProvider(),
                        ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "skyblock_grayscale"),
                        DefaultVertexFormat.POSITION_TEX),
                (e) -> {
                    skyblockGrayscale = e;
        ...
        event.registerShader(new ShaderInstance(event.getResourceProvider(),
                        ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "skyblock_screen"),
                        DefaultVertexFormat.POSITION_TEX),
                (e) -> {
                    skyblockScreen = e;
        ...
        event.registerShader(new ShaderInstance(event.getResourceProvider(),
                        ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "skyblock_blueprint"),
                        DefaultVertexFormat.POSITION_TEX),
                (e) -> {
                    skyblockBlueprint = e;
        ...
        event.registerShader(new ShaderInstance(event.getResourceProvider(),
                        ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "skyblock_gameboy"),
                        DefaultVertexFormat.POSITION_TEX),
                (e) -> {
                    skyblockGameboy = e;
        ...
        event.registerShader(new ShaderInstance(event.getResourceProvider(),
                        ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "skyblock_background"),
                        DefaultVertexFormat.POSITION_TEX),
                (e) -> {
        ...
        event.registerShader(new ShaderInstance(event.getResourceProvider(),
                        ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "glass"),
                        DefaultVertexFormat.POSITION_TEX),
                (e) -> {
                    glass = e;
                    SHADERS.put("glass", e);
        ...
        event.registerShader(new ShaderInstance(event.getResourceProvider(),
                        ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "pbr"),
                        ModVertexFormat.PBR),
                (e) -> {
                    pbr = e;
                    SHADERS.put("pbr", e);
