...
public class IllusoriteOreBlockItem extends BlockItem {
    ...
    public IllusoriteOreBlockItem(Block block, Properties properties) {
    ...
    public static ItemStack create(SkyblockType type, SkyblockPass pass, Block block) {
        if (!(block instanceof IllusoriteOreBlock)) {
