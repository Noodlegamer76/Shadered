...
public class InitItems {
    ...
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.createItems(ShaderedMod.MODID);
    ...
    public static final DeferredHolder<Item, Item> WINDOW = ITEMS.register("window",
    ...
    public static final DeferredHolder<Item, Item> SPACE_COMPRESSOR = ITEMS.register("space_compressor",
            () -> new BlockItem(InitBlocks.SPACE_COMPRESSOR.get(), new Item.Properties()));

    public static final DeferredHolder<Item, Item> CONFIGURATOR = ITEMS.register("configurator",
