...
public class SkyblockRenderer {
    ...
    public static final ResourceLocation STORMY = ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "textures/environment/stormy");
    public static final ResourceLocation OCEAN = ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "textures/environment/ocean");
    public static final ResourceLocation ECLIPSE = ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "textures/environment/eclipse");
    public static final ResourceLocation LIGHT = ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "textures/environment/light");
    public static final ResourceLocation FOREST = ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "textures/environment/forest");
    public static final ResourceLocation IRIDIA = ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "textures/environment/iridia");

    public static final ResourceLocation GRAINY = ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "textures/noise/grainy.png");
    public static final ResourceLocation GRAINY2 = ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "textures/noise/grainy2.png");
    public static final ResourceLocation MANIFOLD = ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "textures/noise/manifold.png");
    public static final ResourceLocation MILKY = ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "textures/noise/milky.png");
    public static final ResourceLocation SWIRL = ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "textures/noise/swirl.png");

    public static final ResourceLocation PIXEL = ResourceLocation.fromNamespaceAndPath(ShaderedMod.MODID, "textures/environment/pixel.png");
